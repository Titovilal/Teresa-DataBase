 ...
 */
public class Panel_AC extends javax.swing.JPanel {

    public Panel_AC() {
        initComponents();
        scrollPaneMain.getVerticalScrollBar().setUnitIncrement(12);
        this.setSize(735, 581);
        buttonAddCliente.setActionCommand("6");
        buttonBuscar.setActionCommand("7");

    }

    public void setActionListener(ActionListener al) {
        buttonBuscar.addActionListener(al);
        buttonAddCliente.addActionListener(al);
    }
